...
#df=get_historical_from_csv('icicin.csv')
...
""""
    ...
    print("Accuracy of the model is", maximum_accuracy, "%")

"""
def your_route_function():
        return render_template('result.html', arima_pred=arima_pred, lstm_pred=lstm_pred,
                               lr_pred=lr_pred, error_lstm=error_lstm, error_arima=error_arima, error_lr=error_lr,
